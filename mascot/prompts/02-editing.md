...
> **Framing:** desk · **Loop:** 3.6 s (108 frames at 30 fps) · **Used for:** subtitle and edit jobs (`subtitle`), any review-and-correct step

He sits at a desk with FOUR arms instead of two, each doing a different job at once: one holds a red correcting pen, one a stylus over a tablet, one holds up a proof sheet, one reaches for a mug. He looks entirely unbothered by having four arms.
...
| `arm-upper-right.png` | layer | The upper right arm, holding a red correcting pen. |
| `prop-pen.png` | layer | red correcting pen |
| `prop-stylus.png` | layer | thin stylus |
| `prop-proof.png` | layer | sheet of paper covered in wavy squiggle lines and small red… |
| `prop-mug.png` | layer | chipped ceramic mug |
| `bubble-left.png` | layer | Empty thought cloud, trailing circles to the left. |
| `icon-left.png` | layer | a small checklist card bearing one green tick and one red cr… |
...
The rig that implements this lives in `../rig/02-editing.rig.json`.
...
WEARING: a cream dress shirt with the sleeves rolled to the elbow, under a slate-blue cardigan.
...
SCENE: He sits at a desk with FOUR arms instead of two, each doing a different job at once: one holds a red correcting pen, one a stylus over a tablet, one holds up a proof sheet, one reaches for a mug. He looks entirely unbothered by having four arms.
...
```
A wooden desk running across the bottom of the frame. On it, a flat tablet, a marked-up proof sheet, a mug, and scattered pens. A pale sketched bookshelf behind. Empty — no character anywhere in the image.
...
```
From this illustration, redraw ONLY the character's body: the torso, the shoulders, both arms hanging in a neutral resting position. Wearing a slate-blue cardigan over a cream shirt with sleeves rolled to the elbow.
...
```
From this illustration, redraw ONLY the character's head and horns, facing forward with heavy-lidded eyes and a slightly pressed, patient mouth. Include the forehead bumps, the flat nose, the mouth and the two tusks.
...
## 7. `arm-upper-right.png`

Attach `pose.png`.

```
From this illustration, redraw ONLY the character's upper right arm, complete from the shoulder joint to the fingertips, holding a red correcting pen. Cream shirt sleeve rolled to the elbow, sage green three-fingered hand.
...
```
A single red correcting pen, drawn on its own, seen from the side, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single thin stylus, drawn on its own, seen from the side, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single sheet of paper covered in wavy squiggle lines and small red correction marks, no real letters, drawn on its own, seen from slightly above, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single chipped ceramic mug, drawn on its own, seen from the side, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single a small checklist card bearing one green tick and one red cross, and no writing at all, drawn small and centred, with nothing around it. No bubble, no cloud, no frame.
