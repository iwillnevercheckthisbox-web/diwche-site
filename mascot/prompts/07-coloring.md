...
> **Framing:** desk · **Loop:** 4.0 s (120 frames at 30 fps) · **Used for:** visual studio and banner rendering, any colour or styling pass

He sits at a table, dipping a brush into a paint palette and dabbing colour onto a half-finished drawing. A cup of coloured pencils stands beside him and loose pencils lie across the table.
...
| `arm-right.png` | layer | The right arm, holding a paintbrush pointed down toward a table. |
| `prop-brush.png` | layer | paintbrush with a wooden handle |
| `prop-palette.png` | layer | round wooden paint palette with six wells of different colou… |
| `prop-drawing.png` | layer | sheet of paper with a loose half-coloured drawing of a small… |
| `bubble-right.png` | layer | Empty thought cloud, trailing circles to the right. |
| `icon-right.png` | layer | a row of six coloured pencils standing side by side |
...
The rig that implements this lives in `../rig/07-coloring.rig.json`.
...
WEARING: a cream dress shirt with the sleeves rolled to the elbow, under a teal smock dotted with paint spots.
...
SCENE: He sits at a table, dipping a brush into a paint palette and dabbing colour onto a half-finished drawing. A cup of coloured pencils stands beside him and loose pencils lie across the table.
...
```
A wooden table running across the bottom of the frame. On it: a round paint palette with wells of colour, a cup of coloured pencils, and several loose pencils lying scattered. A pale sketched bookshelf behind. Empty — no character anywhere in the image.
...
```
From this illustration, redraw ONLY the character's body: the torso, the shoulders, both arms hanging in a neutral resting position. Wearing a teal smock dotted with paint spots over a cream shirt with sleeves rolled to the elbow.
...
```
From this illustration, redraw ONLY the character's head and horns, facing forward with heavy-lidded eyes and a faint contented half-smile. Include the forehead bumps, the flat nose, the mouth and the two tusks.
...
```
From this illustration, redraw ONLY the character's right arm, complete from the shoulder joint to the fingertips, holding a paintbrush pointed down toward a table. Cream shirt sleeve rolled to the elbow, sage green three-fingered hand.
...
```
A single round wooden paint palette with six wells of different colour, drawn on its own, seen from slightly above, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single sheet of paper with a loose half-coloured drawing of a small creature on it, drawn on its own, seen from slightly above, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single a row of six coloured pencils standing side by side, drawn small and centred, with nothing around it. No bubble, no cloud, no frame.
