...
> **Framing:** desk · **Loop:** 4.0 s (120 frames at 30 fps) · **Used for:** review queues, pre-publish checks

He sits at a desk holding a magnifying glass over a large world map, checking it closely. A checklist and loose papers lie beside the map.
...
| `arm-right.png` | layer | The right arm, holding a round magnifying glass by its handle, down over a desk. |
| `prop-magnifier.png` | layer | round magnifying glass with a wooden handle and a clear lens |
| `prop-map.png` | layer | loose hand-drawn world map in pale grey and blue, no labels… |
| `prop-checklist.png` | layer | checklist sheet with four short squiggle lines and empty tic… |
| `bubble-right.png` | layer | Empty thought cloud, trailing circles to the right. |
| `icon-right.png` | layer | a round magnifying glass |
...
The rig that implements this lives in `../rig/09-final-review.rig.json`.
...
SCENE: He sits at a desk holding a magnifying glass over a large world map, checking it closely. A checklist and loose papers lie beside the map.
...
```
A wooden desk running across the bottom of the frame. On it: a large world map drawn loosely in pale grey and blue, a checklist sheet, and scattered loose papers. A faint sketched bookshelf behind. Empty — no character anywhere in the image.
...
```
From this illustration, redraw ONLY the character's head and horns, facing forward with heavy-lidded eyes narrowed in suspicion, mouth pulled down at one corner. Include the forehead bumps, the flat nose, the mouth and the two tusks.
...
```
From this illustration, redraw ONLY the character's right arm, complete from the shoulder joint to the fingertips, holding a round magnifying glass by its handle, down over a desk. Cream shirt sleeve rolled to the elbow, sage green three-fingered hand.
...
```
A single round magnifying glass with a wooden handle and a clear lens, drawn on its own, seen from slightly above, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single loose hand-drawn world map in pale grey and blue, no labels of any kind, drawn on its own, seen from the front, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single checklist sheet with four short squiggle lines and empty tick boxes beside them, drawn on its own, seen from slightly above, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single a round magnifying glass, drawn small and centred, with nothing around it. No bubble, no cloud, no frame.
