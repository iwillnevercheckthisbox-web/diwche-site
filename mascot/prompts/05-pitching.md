...
> **Framing:** standing · **Loop:** 4.0 s (120 frames at 30 fps) · **Used for:** strategy and pitch views, anything presenting a proposed direction

He stands facing the viewer, holding up a storyboard sheet in one hand and pointing at it with a pencil in the other, presenting an idea. A larger storyboard poster hangs on the wall behind him.
...
| `arm-right.png` | layer | The right arm, extended outward holding a pencil like a pointer. |
| `prop-pencil.png` | layer | yellow pencil |
| `prop-board.png` | layer | small storyboard sheet: a two-by-two grid of empty panels wi… |
| `bubble-right.png` | layer | Empty thought cloud, trailing circles to the right. |
| `icon-right.png` | layer | a small two-by-two storyboard grid with loose squiggle marks… |
...
The rig that implements this lives in `../rig/05-pitching.rig.json`.
...
WEARING: a cream dress shirt with the sleeves rolled to the elbow, under a tan waistcoat.
...
SCENE: He stands facing the viewer, holding up a storyboard sheet in one hand and pointing at it with a pencil in the other, presenting an idea. A larger storyboard poster hangs on the wall behind him.
...
```
A plain cream ground with a soft shadow area. A large storyboard poster pinned to the wall behind, drawn as a faint grey grid of empty panels with squiggle marks inside. Empty — no character anywhere in the image.
...
```
From this illustration, redraw ONLY the character's body: the torso, the shoulders, both arms hanging in a neutral resting position, and the legs and feet. Wearing a tan waistcoat over a cream shirt with sleeves rolled to the elbow.
...
```
From this illustration, redraw ONLY the character's head and horns, facing forward with heavy-lidded eyes and a small hopeful half-smile. Include the forehead bumps, the flat nose, the mouth and the two tusks.
...
```
From this illustration, redraw ONLY the character's right arm, complete from the shoulder joint to the fingertips, extended outward holding a pencil like a pointer. Cream shirt sleeve rolled to the elbow, sage green three-fingered hand.
...
```
A single yellow pencil, drawn on its own, seen from the side, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single small storyboard sheet: a two-by-two grid of empty panels with loose squiggle marks inside, no real writing, drawn on its own, seen from slightly above, at a slight three-quarter tilt. Nothing else in the image.
...
```
A single a small two-by-two storyboard grid with loose squiggle marks inside the panels, drawn small and centred, with nothing around it. No bubble, no cloud, no frame.
