...
export const DE: FunnelCopy = {
  ...
  screens: [
...

    {
      ...
      kind: 'rivals',
      showIf: { screen: 'stage', is: 'active' },
      eyebrow: 'Womit du dich vergleichst',
      title: 'Nenn eine Seite, an der du dich misst.',
      lead: 'Optional, und es verändert die Analyse. Er findet Seiten, die du ohnehin markierst — aber der Vergleich, den du wirklich glaubst, ist der, den du selbst im Kopf hast. Du kennst deine Nische besser als jede Liste.',
  ...
  result: {
    ...
    sections: {
      ...
      audience: 'Wer wirklich da ist',
      peers: 'Die Seiten neben dir',
      words: 'Was du schreibst',
    },
    verdicts: {
      good: 'Stark',
      weak: 'Schwach',
    ...
    labels: {
      started: 'Seit dem Anfang',
      window: 'Was er gelesen hat',
      pace: 'Das Tempo',
      now: 'Seit deinem letzten Beitrag',
      gap: 'Die stille Strecke',
      trend: 'Wohin es geht',
      format: 'Falsches Format',
      best: 'Der eine, der lief',
      answering: 'Wie viele antworten',
      asleep: 'Die, die nie antworten',
      prune: 'Was du dagegen tust',
      'peer-pace': 'Wie oft die posten',
      peer: 'Eine Seite deiner Größe',
      'peer-format': 'Was die machen',
      hashtags: 'Hashtags',
      asks: 'Nach einer Antwort fragen',
      bio: 'Deine Bio',
      caption: 'Caption-Gewohnheit',
      opening: 'Immer derselbe Einstieg',
      timing: 'Wann sie landen',
    },
